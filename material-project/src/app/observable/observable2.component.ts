/**
 * [rxjs6-observable-http](https://stackblitz.com/edit/rxjs6-observable-http?file=src%2Fapp%2Fapp.module.ts)
 */
...
export class Observable2EventHttpComponent implements OnInit, OnDestroy {
  // ① Angular forms
